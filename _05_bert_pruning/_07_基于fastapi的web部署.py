...
# todo 导入写好的预测函数
from _06_p_bert_predict_fun import predict_fun
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <h1>二次元投诉分类娘</h1>
            <div class="subtitle">✧ 基于Bert的剪枝模型 ✧ 把你输入的投诉文本分好类哒~ <span class="heart">♥</span></div>
        </div>
...
if __name__ == '__main__':
    ...
    print("接口文档: http://127.0.0.1:9096/docs")
    print("=" * 50)
